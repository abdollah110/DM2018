...
#        print  "----> This is the proper B0=", M[1] , M[2], "  Br=",BR_visible*(1-BR_visible)*2
        ...
        print 'hlimitxsec2->SetBinContent(%d,%d,%2.2f);'%(XbinLQ,YbinDM,LQXS(M[1])* 1000 )
...
with open(FinalSampleDirectory) as data_file:
    ...
    for bin, M in enumerate(MassXS,1):
        ...
        print 'hlimitxsec2->SetBinContent(%d,%d,%2.2f);'%(XbinLQ,YbinDM,BR )
...
with open(FinalSampleDirectory) as data_file:
    ...
    for bin, M in enumerate(MassXS,1):
        ...
        print 'hlimitxsec2->SetBinContent(%d,%d,%2.2f);'%(XbinLQ,YbinDM,LQXS(M[1])* 1000 *BR)
