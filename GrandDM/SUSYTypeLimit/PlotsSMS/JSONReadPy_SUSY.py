...
for FinalSampleDirectory in LimitJson:
    with open(FinalSampleDirectory) as data_file:
        ...
        for bin, M in enumerate(MassXS,1):
            ...
            XbinLQ=GetLQBin(M[1])
            YbinDM=GetDMBin(M[2])
            print '%d  %d  %2.3f  %2.3f  %2.3f  %2.3f  %2.3f  %2.3f  %2.3f '%(M[1], M[2], (LQXS(M[1])* 1000 * BR),  data[str(M[0])]["obs"]/(LQXS(M[1])* 1000 * BR), data[str(M[0])]["obs"]/(LQXS(M[1])* 1000 * BR), data[str(M[0])]["obs"]/(LQXS(M[1])* 1000 * BR),data[str(M[0])]["exp0"]/(LQXS(M[1])* 1000 * BR), data[str(M[0])]["exp+2"]/(LQXS(M[1])* 1000 * BR), data[str(M[0])]["exp-2"]/(LQXS(M[1])* 1000 * BR)),1.00,1.00

            outTxt.write('%d  %d  %2.3f  %2.3f  %2.3f  %2.3f  %2.3f  %2.3f  %2.3f %2.3f  %2.3f \n'%(M[1], M[2], (LQXS(M[1])* 1000 * BR),  data[str(M[0])]["obs"]/(LQXS(M[1])* 1000 * BR), data[str(M[0])]["obs"]/(LQXS(M[1])* 1000 * BR), data[str(M[0])]["obs"]/(LQXS(M[1])* 1000 * BR),data[str(M[0])]["exp0"]/(LQXS(M[1])* 1000 * BR), data[str(M[0])]["exp+2"]/(LQXS(M[1])* 1000 * BR), data[str(M[0])]["exp-2"]/(LQXS(M[1])* 1000 * BR),1.00,1.00))
