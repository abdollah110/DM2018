...
#    c.Modified()
    c.SaveAs("_Finalplot"+categoriy+Status+"_W_CR.pdf")
...
FileNamesInfo=[
               ["postfit_shapes_W_CR.root","Codex__mj_cmb_1_13TeV_prefit","m_{#muj} [GeV]","#mu j ",2000,"Codex_","LQ 1200GeV (DM 500 GeV)",10],
#               ["postfit_shapes_W_CR.root","Codex__mj_cmb_1_13TeV_postfit","m_{#muj} [GeV]","#mu j ",2000,"Codex_","LQ 1200GeV (DM 500 GeV)",10],
               ]
