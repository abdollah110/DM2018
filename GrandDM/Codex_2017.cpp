...
int main() {
    ...
    bkg_procs["mj_2017"] = {"ZTT", "W", "QCD", "TT","VV","SingleTop"};
 ...
 // Or equivalently, specify the mass points explicitly:
    ...
    for (string era : {"13TeV"}) {
        for (string chn : chns) {
            ...
            string file = aux_shapes + input_folders[chn] + "/_mj_LQMass_Final_2017.root";
...
//    .AddSyst(cb, "CMS_scale_met_JES", "shape", SystMap<>::init(1.00));
    ...
    cb.cp().backgrounds().ExtractShapes(
                                        aux_shapes + "/_mj_LQMass_Final_2017.root",
                                        "$BIN/$PROCESS",
...
//    bbb.AddBinByBin(cb.cp().backgrounds(), cb);
    ...
    //string folder = "outputCodex_Approval_Combine_v1/LIMITS";
string folder = "outputCodex_v5_new2017Naming/LIMITS";
