...
def make_legend():
        output = ROOT.TLegend(0.5, 0.55, 0.9, 0.85, "", "brNDC")
...
#    c.Modified()
    c.SaveAs("_Finalplot"+categoriy+Status+"_TT_CR.pdf")
...
#FileNamesInfo=[
#               ["postfit_shapes.root","Codex__mj_cmb_1_13TeV_prefit","m_{#muj} [GeV]","#mu j ",2000,"Codex_","LQ 1200GeV (DM 500 GeV)",10],
#               ["postfit_shapes.root","Codex__mj_cmb_1_13TeV_postfit","m_{#muj} [GeV]","#mu j ",2000,"Codex_","LQ 1200GeV (DM 500 GeV)",10],
#               ]

FileNamesInfo=[
               ["postfit_shapes_TT_CR.root","Codex__mj_cmb_1_13TeV_prefit","m_{#muj} [GeV]","#mu j ",2000,"Codex_","LQ 1200GeV (DM 500 GeV)",10],
#               ["postfit_shapes_TT_CR.root","Codex__mj_cmb_1_13TeV_postfit","m_{#muj} [GeV]","#mu j ",2000,"Codex_","LQ 1200GeV (DM 500 GeV)",10],
               ]
