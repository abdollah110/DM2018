                                                    ...
                                                    for (int itopRW = 0; itopRW < size_topPtRW; itopRW++) {
                                                        ...
                                                        if (!( std::find(HistNamesFilled.begin(), HistNamesFilled.end(), FullStringName) != HistNamesFilled.end())){
                                                            ...
                                                            if (1){
                                                                ...
                                                                plotFill(CHL+"_LQMass"+FullStringName,LQ4Momentum.M(),200,0,2000);
                                                                plotFill(CHL+"_LepPt"+FullStringName,muPt->at(imu),2000,0,2000);
                                                                
                                                                plotFill(CHL+"_tmass_MuMet"+FullStringName,tmass_MuMet,200,0,2000);
                                                                plotFill(CHL+"_MET"+FullStringName,pfMET,200,0,2000);
                                                                plotFill(CHL+"_METPhi"+FullStringName,pfMETPhi,400,-4,4);
                                                                plotFill(CHL+"_JetPt"+FullStringName,jetPt->at(ijet) ,2000,0,2000);
                                                                plotFill(CHL+"_JetEta"+FullStringName,jetEta->at(ijet),120,-3,3);
                                                                
                                                                plotFill(CHL+"_LepEta"+FullStringName,muEta->at(imu),100,-2.5,2.5);
                                                                plotFill(CHL+"_tmass_LQMet"+FullStringName,tmass_LQMet,200,0,2000);
                                                                
                                                                plotFill(CHL+"_dPhi_Jet_Met"+FullStringName,deltaPhi(Jet4Momentum.Phi(),pfMETPhi),160,0,3.2);
                                                                plotFill(CHL+"_dPhi_Mu_Met"+FullStringName,deltaPhi(Mu4Momentum.Phi(),pfMETPhi),160,0,3.2);
                                                                plotFill(CHL+"_dPhi_Mu_Jet"+FullStringName,deltaPhi(Mu4Momentum.Phi(),Jet4Momentum.Phi()),160,0,3.2);
                                                                plotFill(CHL+"_NumJet"+FullStringName,numJet,10,0,10);
                                                                plotFill(CHL+"_NumBJet"+FullStringName,numBJet,10,0,10);
                                                                plotFill(CHL+"_WBosonMass"+FullStringName,WBosonMass,200,0,2000);
                                                                plotFill(CHL+"_genHT"+FullStringName,genHT,200,0,2000);
                                                                plotFill(CHL+"_recoHT"+FullStringName,recoHT,300,0,3000);
                                                                plotFill(CHL+"_ST"+FullStringName,recoHT+muPt->at(imu),300,0,3000);
                                                                plotFill(CHL+"_dR_Mu_Jet"+FullStringName,Jet4Momentum.DeltaR(Mu4Momentum),500,0,5);
                                                                plotFill(CHL+"_LepPhi"+FullStringName,muPhi->at(imu),400,-4,4);
                                                                plotFill("_FinalBTagSF"+FullStringName, FinalBTagSF,200,0,2);
                                                                
                                                                plotFill(CHL+"_nVtx"+FullStringName,nVtx,100,0,100);
