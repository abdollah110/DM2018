...
def MakePlot(FileName,categoriy,HistName,Xaxis,Info,RB_,channel,yMin,isLOG,ttbarCR,MTLegend,SSS):
#    yMin*=0.1
...
#    W2016=file2016.Get(categoriy).Get("W")
    W2016=file2016.Get(categoriy).Get("data_obs")
    W2016.Rebin(RB_)
#    W2016.Scale(1./W2016.Integral())


#    W2017=file2017.Get(categoriy).Get("W")
    W2017=file2017.Get(categoriy).Get("data_obs")
    W2017.Rebin(RB_)
...
#    W2017.SetLineColor(ROOT.kRed)
    W2017.SetMarkerColor(3)
    W2017.SetLineColor(ROOT.kGreen)
...
#    W2016.SetLineColor(ROOT.kBlue)
    W2016.SetMarkerColor(9)
    W2016.SetLineColor(9)
...
#    categ.AddText("%s        Norm Ratio=%.2f"%(SSS.replace('WJets_',''),W2017.Integral()/W2016.Integral()))
    categ.AddText("        Norm Ratio=%.2f"%(W2017.Integral()/W2016.Integral()))
...
#    c.SaveAs(InputFilesLocation2017+'_MuJet_W'+outName+SSS+".pdf")
    c.SaveAs(InputFilesLocation2017+'_MuJet_Data'+outName+SSS+".pdf")
                    ...
                    for etalq in lqEta:
                        for reg in region:
                            for isLOG in logStat:
                                ...
                                print "---->", FileName
                                MakePlot(FileName,"MuJet","",axisName,Info,Bin,"",yMin,isLOG,reg,mt,SSS)
