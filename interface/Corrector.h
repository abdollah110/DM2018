...
float Cor94X_Iso_Mu(float pt, float eta , TH2F * HistoId) {
    ...
    if (ptBIN==1 && etaBIN==1)  return 0.9927813488028193;
    else if (ptBIN==2 && etaBIN==1)  return 0.9973322326192515;
    else if (ptBIN==3 && etaBIN==1)  return 0.9975767335443745;
    else if (ptBIN==4 && etaBIN==1)  return 0.9982123404899821;
    else if (ptBIN==5 && etaBIN==1)  return 0.998446695574627;
    else if (ptBIN==6 && etaBIN==1)  return 0.9995299697442489;
    
    else if (ptBIN==1 && etaBIN==2)  return  0.995732951928973;
    else if (ptBIN==2 && etaBIN==2)  return 0.9889686790250191;
    else if (ptBIN==3 && etaBIN==2)  return 0.9947379753441337;
    else if (ptBIN==4 && etaBIN==2)  return 0.9970159957153533;
    else if (ptBIN==5 && etaBIN==2)  return 0.9993462494443384;
    else if (ptBIN==6 && etaBIN==2)  return 1.0000177267113954;
    
    else if (ptBIN==1 && etaBIN==3)  return 0.9914010546323393;
    else if (ptBIN==2 && etaBIN==3)  return 0.9940667663237377;
    else if (ptBIN==3 && etaBIN==3)  return 0.995523772936602;
    else if (ptBIN==4 && etaBIN==3)  return 0.9974679188552951;
    else if (ptBIN==5 && etaBIN==3)  return 0.9985968873383925;
    else if (ptBIN==6 && etaBIN==3)  return 0.9996491176044998;
    
    else if (ptBIN==1 && etaBIN==4)  return 0.9888297103629511;
    else if (ptBIN==2 && etaBIN==4)  return 0.9923197624578961;
    else if (ptBIN==3 && etaBIN==4)  return 0.9949958672766567;
    else if (ptBIN==4 && etaBIN==4)  return 0.9979260585567848;
    else if (ptBIN==5 && etaBIN==4)  return 0.999363924350496;
    else if (ptBIN==6 && etaBIN==4)  return 0.9983468116552913;
...
float Cor94X_ID_Mu(float pt,float eta, TH2F* HistoIso){
    ...
    if (ptBIN==1 && etaBIN==1)  return 0.9910777627756951;
    else if (ptBIN==2 && etaBIN==1)  return 0.987410468262084;
    else if (ptBIN==3 && etaBIN==1)  return 0.9907753279135898;
    else if (ptBIN==4 && etaBIN==1)  return 0.9892483588952047;
    else if (ptBIN==5 && etaBIN==1)  return 0.9855545160334763;
    else if (ptBIN==6 && etaBIN==1)  return 0.9898057377093389;
    
    else if (ptBIN==1 && etaBIN==2)  return  0.9927389275515244;
    else if (ptBIN==2 && etaBIN==2)  return 0.985063939762512;
    else if (ptBIN==3 && etaBIN==2)  return 0.9865359464182247;
    else if (ptBIN==4 && etaBIN==2)  return 0.984913093101493;
    else if (ptBIN==5 && etaBIN==2)  return 0.9839056384760008;
    else if (ptBIN==6 && etaBIN==2)  return 0.984060403143468;
    
    else if (ptBIN==1 && etaBIN==3)  return 0.9924252719877384;
    else if (ptBIN==2 && etaBIN==3)  return 0.9890884461284933;
    else if (ptBIN==3 && etaBIN==3)  return 0.9946469069883841;
    else if (ptBIN==4 && etaBIN==3)  return 0.9926528825155183;
    else if (ptBIN==5 && etaBIN==3)  return 0.9906364222943529;
    else if (ptBIN==6 && etaBIN==3)  return 0.9920464322143979;
    
    else if (ptBIN==1 && etaBIN==4)  return 0.9758095839531763;
    else if (ptBIN==2 && etaBIN==4)  return 0.9745153594179884;
    else if (ptBIN==3 && etaBIN==4)  return 0.9787410500158746;
    else if (ptBIN==4 && etaBIN==4)  return 0.978189122919501;
    else if (ptBIN==5 && etaBIN==4)  return 0.9673568416097894;
    else if (ptBIN==6 && etaBIN==4)  return 0.9766311856731202;
...
///////////////////////////////////////////////
//  Muon Trigger Correction 94X
////////////////////////////////////////////////////////////

float Cor94X_Trigger_Mu(float pt,float eta, TH2F* HistoTrg ){
...
float Cor94X_Trigger_Mu_onlyEta(float eta, TH1F* HistoTrg ){
    ...
    if (eta >= -0.2 && eta < 0.2 ) etaBIN=7;
    if (eta >= 0.2 && eta < 0.3 ) etaBIN=8;
    if (eta >= 0.3 && eta < 0.9 ) etaBIN=9;
    if (eta >= 0.9 && eta < 1.2 ) etaBIN=10;
    if (eta >= 1.2 && eta < 1.6 ) etaBIN=11;
    if (eta >= 1.6 && eta < 2.1 ) etaBIN=12;
    if (eta >= 2.1 && eta < 2.4 ) etaBIN=13;
